...
class ResidualBlockG(nn.Module):
    ...
    def _shortcut(self, x: Tensor) -> Tensor:
        ...
        return x
    # 1 residual block gồm 2 khối hợp nhất (DFBlock_1 và DFBlock_2)
    # 1 khối hợp nhất (DFBlock_1) sẽ thực hiện:
    # AffineBlock + leaky_relu + AffineBlock + leaky_relu + lớp conv_1
